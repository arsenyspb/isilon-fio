...
ssh -i /mnt/isilon/fiotest/control/trusted.key ${pairs[0]} -fqno StrictHostKeyChecking=no "sync && echo 3 > /proc/sys/vm/drop_caches; FILENAME=\"/mnt/isilon/fiotest/${pairs[0]}\" fio --output=/mnt/isilon/fiotest/nfs_fioresult_64k_seqread_${pairs[0]}.txt /mnt/isilon/fiotest/fiojob_64k_seqread";
done
